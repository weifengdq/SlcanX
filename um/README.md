...
- [SlcanX 标准版与隔离版用户手册](#slcanx-标准版与隔离版用户手册)
  - [标准版 SlcanX](#标准版-slcanx)
  - [隔离版 SlcanX-ISO](#隔离版-slcanx-iso)
  - [性能参数参考](#性能参数参考)
  - [LED 指示灯说明](#led-指示灯说明)
    - [通道映射](#通道映射)
    - [状态逻辑](#状态逻辑)
    - [注意事项](#注意事项)
  - [位时间设置参考](#位时间设置参考)
  - [Win 上位机 slcanx](#win-上位机-slcanx)
    - [简要介绍](#简要介绍)
    - [查询上位机版本](#查询上位机版本)
    - [查询 MCU 固件版本](#查询-mcu-固件版本)
    - [MCU 固件更新](#mcu-固件更新)
  - [二次开发](#二次开发)
  - [Linux SocketCAN](#linux-socketcan)
    - [内核驱动](#内核驱动)
    - [SocketCAN开发示例](#socketcan开发示例)
  - [自行开发固件](#自行开发固件)
  - [购买方式与交流群](#购买方式与交流群)
